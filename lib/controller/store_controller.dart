...
import 'package:sq_customer/data/model/response/cart_suggested_item_model.dart';
...
import 'package:sq_customer/data/model/response/recommended_product_model.dart';
import 'package:sq_customer/data/model/response/store_banner_model.dart';
import 'package:sq_customer/data/model/response/store_model.dart';
import 'package:sq_customer/data/model/response/review_model.dart';
import 'package:sq_customer/data/model/response/zone_response_model.dart';
import 'package:sq_customer/data/repository/store_repo.dart';
...
class StoreController extends GetxController implements GetxService {
  ...
  void setCategoryList() {
   ...
   Future<bool> zoneActive(int zoneId) async {
    Response response = await storeRepo.zoneActive(zoneId);
    // print("zoneId1: $zoneId");
    if (response.statusCode == 200) {
      // var responseData = jsonDecode(response.body);
      // if (responseData['active'] != null && responseData['active'] == true) {
        _isActive = true;
      // } else if (responseData['error'] != null) {
      //   // if (responseData['error'] is String) {
      //   //   // debugPrint(responseData['error']);
      //   // } else if (responseData['error'] is Map<String, dynamic>) {
      //   //   // Manejar el mapa de errores según sea necesario
      //   //   Map<String, dynamic> errorMap = responseData['error'];
      //   //    debugPrint('Error: $errorMap');
      //   // }
      //   bool isActive = false;
      // }
      // print("isActive3: $_isActive");
    }
    if (response.statusCode == 404) {
      _isActive = false;
      // print("isActive2: $_isActive");
    }
    // update();
    //  print("isActive1: $_isActive");
    return _isActive;
  }
