...
import 'package:sq_customer/data/model/body/delivery_man_body.dart';
import 'package:sq_customer/data/model/body/store_body.dart';
import 'package:sq_customer/data/model/body/signup_body.dart';
import 'package:sq_customer/data/model/body/social_log_in_body.dart';
import 'package:sq_customer/data/model/response/delivery_man_vehicles.dart';
...
import 'package:sq_customer/data/model/response/zone_model.dart';
import 'package:sq_customer/data/model/response/zone_response_model.dart';
import 'package:sq_customer/data/repository/auth_repo.dart';
...
class AuthController extends GetxController implements GetxService {
  ...
  final List<String> _identityTypeList = ['driving_license', 'nid']; //'passport',
  ...
  Future<ResponseModel> login(String? phone, String password, bool reeviarSms ) async {
    _isLoading = true;
    update();
    Response response = await authRepo.login(phone: phone, password: password ,reeviarSms: reeviarSms);
    ResponseModel responseModel;
    if (response.statusCode == 200) {
  ...
  Future<void> registerStore(StoreBody storeBody) async {
    ...
    int getAddressZone() {
    return authRepo.getAddressZone()?.zoneId ?? 0;
  }
