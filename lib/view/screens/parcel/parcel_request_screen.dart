...
import 'package:sq_delivery_customer/helper/checkout_helper.dart';
...
import 'package:sq_delivery_customer/view/screens/checkout/widget/condition_check_box.dart';
// import 'package:sq_delivery_customer/view/screens/checkout/widget/offline_payment_button.dart';
import 'package:sq_delivery_customer/view/screens/checkout/widget/payment_button.dart';
import 'package:sq_delivery_customer/view/screens/checkout/widget/tips_widget.dart';
import 'package:sq_delivery_customer/view/screens/parcel/widget/card_widget.dart';
import 'package:sq_delivery_customer/view/screens/parcel/widget/delivery_instruction_bottom_sheet.dart';
...
class _ParcelRequestScreenState extends State<ParcelRequestScreen> {
  ...
  Widget _bottomButton(ParcelController parcelController, double charge) {
    ...
    return CustomButton(
      ...
      onPressed: parcelController.acceptTerms ? () async {
        ...
        }else if(await Get.find<StoreController>().zoneActive(Get.find<AuthController>().getAddressZone()) == false) {
          showCustomSnackBar('not_dm_avaibles'.tr);
        }else {
