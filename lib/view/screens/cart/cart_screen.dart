...
import 'package:sq_delivery_customer/view/base/item_widget.dart';
...
import 'package:sq_delivery_customer/view/base/web_constrained_box.dart';
import 'package:sq_delivery_customer/view/base/web_page_title_widget.dart';
import 'package:sq_delivery_customer/view/screens/cart/widget/cart_item_widget.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:sq_delivery_customer/view/screens/cart/widget/web_cart_items_widget.dart';
import 'package:sq_delivery_customer/view/screens/cart/widget/web_suggested_item_view.dart';
            ...
            children: [
              ...
              SafeArea(
                child: CustomButton(
                  ...
                  }*/else if (!storeController.isActive && Get.find<StoreController>().store!.selfDeliverySystem != 1) {
                      showDialog(
                    context: context,
                      ...
                      return AlertDialog(
                        ...
                        content: Column(
                          ...
                          children: [
                            ...
                            // Puedes usar un Icon o un Image para el GIF
                            Image.asset('assets/image/accident.png', height: 100), // Ejemplo de GIF
                            // SizedBox(height: 20),
                            // Text('not_dm_avaibles'.tr),
