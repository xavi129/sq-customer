                      ...
                      isLoggedIn ? Text(
                        ...
                        onTap: () async {
                          if(!ResponsiveHelper.isDesktop(context)) {
                            await Get.off(() => const StartScreen());
                          }else{
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Row(children: [
                          ...
                          const SizedBox(width: Dimensions.paddingSizeDefault),
                          Expanded(child: Text('send_feedback'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge))),
                        ]),
                      ),
                    ),
                  ]),
