...
import 'package:sq_delivery_customer/view/screens/checkout/widget/checkout_screen_shimmer_view.dart';
import 'package:sq_delivery_customer/view/screens/checkout/widget/payment_method_bottom_sheet.dart';
import 'package:get/get.dart';
import 'package:sq_delivery_customer/view/screens/checkout/widget/bottom_section.dart';
import 'package:sq_delivery_customer/view/screens/checkout/widget/top_section.dart';
    ...
    return Container(
      ...
      child: SafeArea(
        child: CustomButton(
          ...
          Get.find<StoreController>().zoneActive(storeController.store!.zoneId ?? 0);
          ...
          else if (!storeController.isActive && storeController.store!.selfDeliverySystem != 1){
