...
import 'package:sq_delivery_customer/view/screens/language/widget/language_widget.dart';
...
import 'package:sq_delivery_customer/view/screens/language/widget/web_language_widget.dart';
                  ...
                  child: Center(child: FooterView(minHeight: 0.615,
                    child: SizedBox(
                      ...
                      child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        !ResponsiveHelper.isDesktop(context) ? Center(child: Image.asset(Images.logo, width: 300)) : const SizedBox.shrink(),
