...
import 'package:sq_delivery_customer/view/base/not_avaible_dm.dart';
...
class StoreCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool isAvailable = store!.open == 1 && store!.active!; // cerrando store activador
    return OnHover(
      isItem: true,
      child: Stack(
        children: [
            ...
            child: Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Stack(clipBehavior: Clip.none, children: [
                  ...
                  //activa el no disponible
                  !isAvailable 
                      ? const NotAvailableWidget(isStore: true, isAllSideRound: false)
                      : (!Get.find<StoreController>().isActive && store?.selfDeliverySystem != 1)
                          ? const NotAvailabledmWidget(isStore: true)
