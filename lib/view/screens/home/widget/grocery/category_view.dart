...
import 'package:sq_delivery_customer/view/screens/home/widget/category_pop_up.dart';
                  ...
                  child: SizedBox(
                    ...
                    child: Column(children: [
                      ...
                      Expanded(
                        child: Text(
                        categoryController.categoryList![index].name!,
                        style: robotoMedium.copyWith(fontSize: 11, color: Theme.of(context).textTheme.bodyMedium!.color),
                        maxLines: 2, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center,
                      )),
                    ]),
                  ),
