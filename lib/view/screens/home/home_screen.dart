...
import 'package:sq_delivery_customer/view/screens/home/modules/food_home_screen.dart';
import 'package:sq_delivery_customer/view/screens/home/modules/grocery_home_screen.dart';
import 'package:sq_delivery_customer/view/screens/home/modules/pharmacy_home_screen.dart';
import 'package:sq_delivery_customer/view/screens/home/modules/shop_home_screen.dart';
import 'package:sq_delivery_customer/view/screens/home/web_new_home_screen.dart';
import 'package:sq_delivery_customer/view/screens/home/widget/filter_view.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:sq_delivery_customer/view/screens/home/widget/module_view.dart';
...
class HomeScreen extends StatefulWidget {
  ...
  static Future<void> loadData(bool reload) async {
    Get.find<StoreController>().zoneActive(Get.find<AuthController>().getAddressZone());
  ...
  Get.find<StoreController>().getFeaturedStoreList();
    ...
    List<ModuleModel>? modules = Get.find<SplashController>().moduleList;
      if (Get.find<SplashController>().moduleList!.length == 1 && modules!.isNotEmpty ) {
        Get.find<SplashController>().setModule(modules[0]);
         Get.find<SplashController>().setRefreshing(true);
         Get.offAllNamed('/');
         }
      }
  }
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    FirebaseInAppMessaging.instance.triggerEvent('dashboard_screen_opened');
              ...
              slivers: [
                ...
                SliverAppBar(
                  ...
                  title: Center(child: Container(
                    ...
                    child: Row(children: [
                      (splashController.module != null && splashController.configModel!.module == null && splashController.moduleList!.length > 1) ? InkWell(
