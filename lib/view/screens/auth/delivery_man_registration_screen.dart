...
import 'package:sq_delivery_customer/helper/custom_validator.dart';
...
import 'package:sq_delivery_customer/view/screens/auth/widget/condition_check_box.dart';
import 'package:sq_delivery_customer/view/screens/auth/widget/pass_view.dart';
...
class _DeliveryManRegistrationScreenState extends State<DeliveryManRegistrationScreen> {
                                      ...
                                      onPressed: () {
                                        showDialog(
                                          ...
                                          builder: (BuildContext context) {
                                            return AlertDialog(
                                              title: Text('Upload_an_image'.tr),
                                              content: Column(
                                                mainAxisSize: MainAxisSize.min,
                                                children: [
                                                  Image.asset('assets/image/selfie.png'), // Ruta de tu imagen de ayuda
                                                  const SizedBox(height: 10),
                                                  Text('Upload_a_selfie_with_your_ID'.tr),
                                                ],
                                              ),
                                            );
                                          },
  ...
  void _addDeliveryMan(AuthController authController) async {
    ...
    /*if(identityNumber.isEmpty) {
      ...
      showCustomSnackBar('pick_delivery_man_identity_image'.tr);
      ...
      authController.registerDeliveryMan(DeliveryManBody(
        ...
        identityNumber: 'x', identityType: authController.identityTypeList[authController.identityTypeIndex],
