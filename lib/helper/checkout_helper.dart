...
class CheckoutHelper {
  ...
  static Future<bool> zoneActive(int i, {required int zoneId}) async {
  // Lógica para determinar si la zona está activa
  bool isActive = false;

  // Llama al método zoneActive de StoreController pasando el valor de zoneId
  bool result = await Get.find<StoreController>().zoneActive(zoneId);

  // Reasigna un nuevo valor a isActive basado en el resultado de la llamada
  isActive = result;
  // print("isActive: $isActive");
  // Devuelve el valor de isActive
  return isActive;
}
