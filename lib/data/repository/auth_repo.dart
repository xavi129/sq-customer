...
class AuthRepo {
  ...
  Future<Response> login({String? phone, String? password , bool? reeviarSms}) async {
    String guestId = getGuestId();
    Map<String, String> data = {
      "phone": phone!,
      "password": password!,
      "reeviar_sms": reeviarSms.toString(),
    };
 ...
 AddressModel? getAddressZone() {
  AddressModel? address;
      if(sharedPreferences.containsKey(AppConstants.userAddress)) {
      // print('zone_id___');
      try {
       address = AddressModel.fromJson(jsonDecode(sharedPreferences.getString(AppConstants.userAddress)!));
      }catch(_) {}
